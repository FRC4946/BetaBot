...
/**
 * Class implements a PID Control Loop. ->Copied from PIDController, but
 * integrate the result, rather than overwrite
 *
 * Creates a separate thread which reads the given PIDSource and takes care of
 * the integral calculations, as well as writing the given PIDOutput
 */
public class PIDRateController implements IUtility {
    ...
    private class PIDTask extends TimerTask {
        ...
        private PIDRateController m_controller;

        public PIDTask(PIDRateController controller) {
            if (controller == null) {
     ...
     * is 50ms.
     */
    public PIDRateController(double Kp, double Ki, double Kd,
